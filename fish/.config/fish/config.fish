...
set --universal fish_color_search_match   --background 4D5566 # ayu:syntax.accent    highlight history search matches and the selected pager item (must be a background)
